  ...
  return (
    <div>
      <section className="py-8 bg-neutral-300 mb-40">
        <h2 className="text-center text-3xl font-bold md:text-5xl lg:text-left animate-fade-in-up transition-all duration-500 ease-in-out transform hover:translate-y-[5px] hover:text-black text-purple-800">
        ...
        <p className="text-center  mb-4 mt-4 text-3xl text-black sm:text-base md:mb-12 lg:mb-16 animate-fade-in-up delay-100">
          <i>Technology has revolutionized the way we travel, making it more
          convenient, efficient, and personalized. From planning trips through
          online booking<br /> platforms to navigating new destinations with GPS and
          ...
          artificial intelligence <br /> and big data have enabled personalized
      ...
      <section className="mb-10 bg-white">
        <h3 className="text-center text-2xl font-bold md:text-4xl text-purple-800 hover:text-black mb-8">
          Explore Categories
        </h3>
